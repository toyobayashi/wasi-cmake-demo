import { WasiErrno, WasiRights, WasiFileType } from './wasi-types.js'
...
export function getRights (fd, flags, type) {
  let read_or_write_only
  ...
  read_or_write_only = flags & (0 | 1 | 2)
